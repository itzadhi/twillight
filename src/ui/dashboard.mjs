...
function defaultCommands() {
  return [
    ...
    { command: "/ai-elements", description: "AI UI components" },
    { command: "/vercel-sandbox", description: "Generated-code sandbox" },
    { command: "/vercel-workflows", description: "Resumable workflows" },
